...
public class InfoWindowMainActivity extends Activity implements PoiSearch.OnPoiSearchListener {
    private AMap aMap;
...
//    }
        ...
        if (errorCode == 1000) {
            if (poiResult != null && poiResult.getQuery() != null) {
                ...
                if (poiItems != null && poiItems.size() > 0) {
                    ...
                    Toast.makeText(InfoWindowMainActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(InfoWindowMainActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
            }
    ...
    public class ViewPoiOverlay extends PoiOverlay {
        ...
        protected BitmapDescriptor getBitmapDescriptor(int index) {
            View view = null;
            view = View.inflate(InfoWindowMainActivity.this, R.layout.custom_view, null);
            TextView textView = ((TextView) view.findViewById(R.id.title));
