...
public class MapPermissionActivity extends FragmentActivity implements AMapLocationListener, View.OnClickListener, HintDialogFragment.DialogFragmentCallback{
    private AMap amap;
    ...
    private void checkLocationPermission() {
        ...
        if (ContextCompat.checkSelfPermission(MapPermissionActivity.this,
            ...
            //已经获得权限，则执行定位请求。
            Toast.makeText(MapPermissionActivity.this, "已获取定位权限",Toast.LENGTH_SHORT).show();
            startLocation();
        }
    }
    ...
    private void checkStoragePermission() {
        ...
        if (ContextCompat.checkSelfPermission(MapPermissionActivity.this,
            ...
            Toast.makeText(MapPermissionActivity.this, "已获取存储的读写权限",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void requestPermission(int permissioncode) {
        ...
        if (!IsEmptyOrNullString(permission)){
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(MapPermissionActivity.this,
                    permission)) {
                ...
                ActivityCompat.requestPermissions(MapPermissionActivity.this,
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        if (aMapLocation != null
            ...
            Toast.makeText(MapPermissionActivity.this, errText, Toast.LENGTH_LONG).show();
        }
    }
        ...
        switch (requestCode) {
            case LOCATION_PERMISSION_CODE: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(MapPermissionActivity.this,"定位权限已获取",Toast.LENGTH_SHORT).show();
                    Log.i("MY","定位权限已获取");
                    startLocation();
                } else {
                    Toast.makeText(MapPermissionActivity.this,"定位权限被拒绝",Toast.LENGTH_SHORT).show();
                    Log.i("MY","定位权限被拒绝");
            ...
            case STORAGE_PERMISSION_CODE: {
                if (grantResults.length > 0
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(MapPermissionActivity.this,"存储权限已获取",Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MapPermissionActivity.this,"存储权限被拒绝",Toast.LENGTH_SHORT).show();
                    Log.i("MY","定位权限被拒绝");
