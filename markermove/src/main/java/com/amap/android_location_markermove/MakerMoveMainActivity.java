...
public class MakerMoveMainActivity extends AppCompatActivity implements AMap.OnMapClickListener, LocationSource, AMapLocationListener {
    private AMap aMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maker_move);
        /*
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        ...
        if (aMapLocation != null) {
            if (aMapLocation != null && aMapLocation.getErrorCode() == 0) {
                ...
                Toast.makeText(MakerMoveMainActivity.this, errText, Toast.LENGTH_SHORT).show();
