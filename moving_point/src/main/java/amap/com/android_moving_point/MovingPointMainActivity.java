...
public class MovingPointMainActivity extends Activity implements AMap.OnMapLoadedListener, View.OnClickListener {
    public int time = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movind_point);
